...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m8BFF5A06396E9EC8E4C4235B4C0F9DF529E380C3(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 49));
		return (RuntimeObject*)L_0;
	}
}
// Method Definition Index: 21117
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_mBFAD8DD78E63815A2396818DCC030F8B27E9E5B4_gshared (Dictionary_2_t9E2CD61857E2645197B7279CE040480C40510DD8* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		RuntimeObject* L_0 = ___0_key;
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_mB01DD2B59E4F69323C671D9DCBBD5D919D43BE6B(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 50));
		if (!L_1)
		{
			goto IL_0030;
		}
	}
	{
		RuntimeObject* L_2 = ___0_key;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_mAD963094090382EF45DACAFC6D19A94968C85D6B(__this, ((*(Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 12)))), il2cpp_rgctx_method(method->klass->rgctx_data, 13));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mF1598D9A2BE47C5C9C2994A99F217A7FD624EAC3(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 53));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
